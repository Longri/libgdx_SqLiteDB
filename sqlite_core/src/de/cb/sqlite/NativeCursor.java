...
public class NativeCursor extends CoreCursor
{
	private ResultSet rs;
	private PreparedStatement ps;
	private int rowcount;

	public NativeCursor(ResultSet rs, PreparedStatement ps)
	{
		this.rs = rs;
		this.ps = ps;
	}

	public NativeCursor(ResultSet rs, int rowcount, PreparedStatement ps)
	{
		this.rs = rs;
